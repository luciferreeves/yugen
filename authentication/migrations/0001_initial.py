    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("mal_token_type", models.CharField(blank=True, max_length=255)),
                ("mal_token_expires_in", models.DateTimeField(blank=True, null=True)),
                ("mal_access_token", models.CharField(blank=True, max_length=1024)),
                ("mal_refresh_token", models.CharField(blank=True, max_length=1024)),
                (
                    "groups",
